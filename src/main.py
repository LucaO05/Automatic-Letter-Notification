...
def main():
    email_service = EmailService(Config.smtp_server, Config.smtp_port, Config.sender_Email, Config.sender_Password, Cofrom gpio_service import GPIOService
from email_service import EmailService
from config import Config
import time
